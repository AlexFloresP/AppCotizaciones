...
public class MyadapterTotalesAccesorios extends BaseAdapter {
    private Context context;
    private int layout;
    private List<Accesorios> accesorios;

    public MyadapterTotalesAccesorios(Context context, int layout, List<Accesorios> accesorios) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = layoutInflater.inflate(R.layout.list_item_totales, null);
       ...
       // TextView textMatricula = v.findViewById(R.id.idAccesoriopdf);
       // TextView textNombre = v.findViewById(R.id.nombreAccesoriopdf);
        TextView textprecio = v.findViewById(R.id.Costo_Extra_totalpdf);
