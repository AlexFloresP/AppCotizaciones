...
public class MyadapterAccesoriosPdf extends BaseAdapter {
    private Context context;
    private int layout;
    private List<Accesorios> accesorios;

    public MyadapterAccesoriosPdf(Context context, int layout, List<Accesorios> accesorios) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = layoutInflater.inflate(R.layout.list_item_pdf, null);
        ...
        TextView textprecio = v.findViewById(R.id.Costo_Extrapdf);
